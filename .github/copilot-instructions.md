# Copilot Instructions — PatenTrack Prosecution Tracker

## Project Context

This is a WordPress plugin that queries the USPTO Open Data Portal (ODP) API to retrieve
patent prosecution fee payment data and displays it on a visual timeline. It is hosted on
SiteGround.
...
- CSS: BEM naming, CSS custom properties for theming
- React: Functional components with hooks, no class components
- Use lucide-react for icons (already bundled with @wordpress/components)
...
- API key in wp-config.php: `define('PATENTRACK_USPTO_API_KEY', '...')`
